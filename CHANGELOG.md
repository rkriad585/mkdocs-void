...
- [Added] feat: auto-open search on page load, delete FIX.md
- [Fixed] fix: focus search input immediately on popup open
- [Fixed] fix: search URLs, SPA click guard, caching, accessibility
